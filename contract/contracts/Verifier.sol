...
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            qc: Honk.G1Point({ 
               x: uint256(0x0423913b4bf368d78ff5ab65b7fa67205e0e2a889bd711e7e79e0bebda962812),
               y: uint256(0x2f117399586f8325c0450deb5e0ada41ebbd4518d6581ba53a9e0cc5ae2db7ad)
            }),
            qArith: Honk.G1Point({ 
            ...
            s4: Honk.G1Point({ 
               x: uint256(0x2e7c97ee52787847281e9328cd32f529bc671d05255bdb3a58df3c3f241d6c2e),
               y: uint256(0x2999e9e76f0f011de749acf0ddb472446777efac1abba91e70f602e8dea4ee40)
            }),
            t1: Honk.G1Point({ 
            ...
            id1: Honk.G1Point({ 
               x: uint256(0x26b02286c3da35d28db313725d31005f6e954c370b5397816bd3a6bf4348c448),
               y: uint256(0x2981901668a95480dd7de458df6723712d3289920db48dfd0baf2a8729e5273f)
            }),
            id2: Honk.G1Point({ 
